...
def save_checkpoint(params, checkpoint_path='/workspace/overcooked-v2_saves/ippo_rnn/'):
    os.makedirs(checkpoint_path, exist_ok=True)
    checkpoint_file = os.path.join(checkpoint_path, f"checkpoint_1.pkl")
...
def main(config):
    ...
    with jax.disable_jit(False):
        ...
        save_checkpoint(jax.device_get(out["runner_state"][0]).params)
